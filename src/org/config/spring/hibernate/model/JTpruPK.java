 ...
 */
@Embeddable
public class JTpruPK implements Serializable {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 41 * hash + Objects.hashCode(this.IdOrder);
        hash = 41 * hash + Objects.hashCode(this.Pcode);
        hash = 41 * hash + Objects.hashCode(this.Salesman);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final JTpruPK other = (JTpruPK) obj;
